...
# 特别说明：基于抓包 2026-06-01-140035 适配 pwa.php 接口
# 关键字段：home_pop_ads(九宫格)、start_screen_ads、pop_ads、indexBanner、buoy 等
# 更新时间：2026-06-01
...
^https?:\/\/[^\/]+\/pwa\.php url script-response-body https://raw.githubusercontent.com/89996462/Quantumult-X/main/ghs/91dspad.js
...
function stripAds(node) {
  ...
  for (var j = 0; j < keys.length; j++) {
    ...
    if (k === "list" && Array.isArray(v) && v.length && isAdItem(v[0])) {
      node[k] = [];
      continue;
    }
    stripAds(v);
